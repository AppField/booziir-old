...
export class IngredientsNonAlcoholicService implements IFirestoreService<Ingredient>{
  ...
  constructor(
    ...
    this.collectionPath = `${userCollectionName}/${this.authService.userValue().uid}/non-alcoholics`;
